...
Common files used by iterami repositories. Many repositories will require this one to properly function, but iterami repositories running on GitHub Pages and iterami repositories cloned via the `/iterami/fetch-iterami-repositories.sh` iterami/Scripts script will properly find the files they need.
