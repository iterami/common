      ...
      'shaders': [
        webgl_shader_create({
          'source':
            ...
            +         ');'
            +     '}'
            +     'gl_FragColor = fragment_color * vec4(vec_lighting, alpha);'
            + '}',
        ...
        webgl_shader_create({
          'source':
            ...
            + 'varying vec4 vec_position;'
            + 'void main(void){'
            +     'vec_position = mat_perspectiveMatrix * mat_cameraMatrix * vec_vertexPosition;'
            +     'gl_Position = vec_position;'
            +     'gl_PointSize = 500. / length(gl_Position.xyz);'
