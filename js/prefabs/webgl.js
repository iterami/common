    ...
    webgl_entity_create({
      ...
      'entities': [
        ...
        },
        {
          ...
          'vertex_colors': args.line_color,
          'vertices': [
            -half_length + line_width, .01, -goalbox_width_half,
            -half_length + line_width, .01, -goalbox_width_half + line_width,
            -half_length + goalbox_length, .01, -goalbox_width_half,
            -half_length + goalbox_length - line_width, .01, -goalbox_width_half + line_width,
            -half_length + goalbox_length, .01, goalbox_width_half,
            -half_length + goalbox_length - line_width, .01, goalbox_width_half - line_width,
            -half_length + line_width, .01, goalbox_width_half,
            -half_length + line_width, .01, goalbox_width_half - line_width,
        ...
        },
        {
          ...
          'vertices': [
            ...
            -half_length + penaltybox_length - line_width, .01, -penaltybox_width_half + line_width,
            -half_length + penaltybox_length, .01, penaltybox_width_half,
            -half_length + penaltybox_length - line_width, .01, penaltybox_width_half - line_width,
            -half_length + line_width, .01, penaltybox_width_half,
            -half_length + line_width, .01, penaltybox_width_half - line_width,
